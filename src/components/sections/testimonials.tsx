...
const TestimonialsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-32 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 relative overflow-hidden">
      {/* Background Elements */}
